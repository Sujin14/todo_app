...
class TaskViewModel extends ChangeNotifier {
  ...
  bool _isBusy = false; // used to show shimmer during add/edit/delete
  String _searchQuery = '';
  String _sortBy = 'dueDate'; // 'dueDate' or 'priority' or 'category'
  ...
  void _applyFilters() {
    _filteredTasks = _allTasks.where((t) {
      final matchesQuery = t.title.toLowerCase().contains(_searchQuery) ||
  ...
  // show shimmer (busy) while operation is in progress
